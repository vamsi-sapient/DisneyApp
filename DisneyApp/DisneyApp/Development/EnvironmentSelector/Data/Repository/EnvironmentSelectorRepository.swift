...
class EnvironmentSelectorRepository: EnvironmentSelectorRepositoryProtocol {
    private let localDataStore: EnvironmentSelectorDataStoreProtocol
    private let mapper: DTOToDomainModelMapper
    
    init(localDataStore: EnvironmentSelectorDataStoreProtocol, mapper: DTOToDomainModelMapper) {
