...
class EnvironmentSelectorViewModel: BaseViewModel, EnvironmentSelectorViewModelProtocol {
    ...
    init(usecase: EnvironmentSelectorUsecaseProtocol, state: EnvironmentSelectorViewState) {
